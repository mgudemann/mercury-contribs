...
:- pragma foreign_type("C", mp_int, "fp_int*")
...
:- pred fp_init(string::in, int::in, mp_int::out) is det.

:- pragma foreign_proc("C",
                      fp_init(String::in, Radix::in, Mp_Int::out),
                      [will_not_call_mercury, promise_pure, thread_safe],
                      "
                      Mp_Int = MR_GC_NEW_ATTRIB(fp_int, MR_ALLOC_ID);
                      fp_init(Mp_Int);
                      fp_read_radix(Mp_Int, String, Radix);
                      ").
...
:- pragma foreign_proc("C",
                      ...
                      [will_not_call_mercury, promise_pure, thread_safe],
                      "
                      C = MR_GC_NEW_ATTRIB(fp_int, MR_ALLOC_ID);
                      fp_init(C);
                      fp_add(A, B, C);
                      ").
...
:- pragma foreign_proc("C",
                      ...
                      [will_not_call_mercury, promise_pure, thread_safe],
                      "
                      B = MR_GC_NEW_ATTRIB(fp_int, MR_ALLOC_ID);
                      fp_init(B);
                      fp_mul_2(A, B);
                      ").
...
:- pragma foreign_proc("C",
                      ...
                      [will_not_call_mercury, promise_pure, thread_safe],
                      "
                      Quot = MR_GC_NEW_ATTRIB(fp_int, MR_ALLOC_ID);
                      Rem = MR_GC_NEW_ATTRIB(fp_int, MR_ALLOC_ID);
                      fp_init(Quot);
                      fp_init(Rem);
                      fp_div(A, B, Quot, Rem);
                      ").
...
:- pragma foreign_proc("C",
                      ...
                      [will_not_call_mercury, promise_pure, thread_safe],
                      "
                      A_SQ = MR_GC_NEW_ATTRIB(fp_int, MR_ALLOC_ID);
                      fp_init(A_SQ);
                      fp_sqr(A, A_SQ);
                      ").
...
:- pragma foreign_proc("C",
                      ...
                      [will_not_call_mercury, promise_pure, thread_safe],
                      "
                      A = MR_GC_NEW_ATTRIB(fp_int, MR_ALLOC_ID);
                      fp_init(A);
                      fp_read_radix(A, S, Radix);
                      ").

from_string(S) = Res :- mp_from_string(S, 10, Res).

mp_init(N, Res) :- fp_init(string.int_to_string(N), 10, Res).
